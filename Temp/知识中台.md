...
value: {{ .Values.app.env.MILVUS_COLLECTION | quote }}

- name: MILVUS_METRIC_TYPE

value: {{ .Values.app.env.MILVUS_METRIC_TYPE | quote }}

{{- if .Values.milvus.auth.enabled }}

- name: MILVUS_USERNAME

value: {{ .Values.milvus.auth.username | quote }}

- name: MILVUS_PASSWORD

value: {{ .Values.milvus.auth.password | quote }}
...
root@xihe-kdp-dev-master01:/data/weknora# helm template -n knowledge knowledge ./ai-knowledge/  --debug                                      

install.go:218: [debug] Original chart version: ""                                                                                           

install.go:235: [debug] CHART PATH: /data/weknora/ai-knowledge                                                                               

Error: parse error at (weknora/templates/app.yaml:159): bad character U+002D '-'                                                             

helm.go:84: [debug] parse error at (weknora/templates/app.yaml:159): bad character U+002D '-'